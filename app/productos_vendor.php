...
<style>
    ...
    .filter-nav-item[data-filter-target="marcas"] { order: 1; }
    .filter-nav-item[data-filter-target="modelos"] { order: 2; }
    .filter-nav-item[data-filter-target="nombres-servicio"] { order: 3; }
    .filter-nav-item[data-filter-target="anio"] { order: 4; }
    .filter-nav-item[data-filter-target="condicion"] { order: 5; }
    .filter-nav-item[data-filter-target="tipo-auto"] { order: 6; }
    .filter-nav-item[data-filter-target="color"] { order: 7; }
    .filter-nav-item[data-filter-target="tapiceria"] { order: 8; }
    .filter-nav-item[data-filter-target="climatizacion"] { order: 9; }
    .filter-nav-item[data-filter-target="referencia"] { order: 10; }
    .filter-nav-item[data-filter-target="categorias"] { order: 11; }
    .filter-nav-item[data-filter-target="precio"] { order: 12; }
...
<section class="toolbar-modern">
    <div class="container-fluid">
        ...
        <div class="type-switcher" id="typeSwitcher">
            <button type="button" class="btn type-chip is-active" data-item-type="producto">Productos</button>
        ...
        <div class="filter-layout-modern">
            <div class="filter-nav-modern">
                ...
                <button type="button" class="filter-nav-item" data-filter-target="nombres-servicio">
                    ...
                    <span class="filter-nav-meta" id="filterGroupCountServiceNames">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="anio" style="display:none;">
                    <span class="filter-nav-label">Año</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="condicion" style="display:none;">
                    <span class="filter-nav-label">Condición</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="tipo-auto" style="display:none;">
                    <span class="filter-nav-label">Tipo auto</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="color" style="display:none;">
                    <span class="filter-nav-label">Color</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="tapiceria" style="display:none;">
                    <span class="filter-nav-label">Tapicería</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="climatizacion" style="display:none;">
                    <span class="filter-nav-label">Climatización</span>
                    <span class="filter-nav-meta">0</span>
                </button>
                <button type="button" class="filter-nav-item vehicle-filter-nav" data-filter-target="referencia" style="display:none;">
            ...
            <div class="filter-content-modern">
                ...
                <section class="filter-detail-panel" data-filter-panel="nombres-servicio">
                    <div class="filter-section-heading">Nombres de servicio</div>
                    <p class="filter-section-copy">Filtra los servicios de esta tienda por el nombre específico publicado.</p>
                    ...
                    <div class="filter-info-card">
                        ...
                        <div class="filter-info-title">Afinación por nombre</div>
                        <p class="filter-info-text">Este bloque se actualiza según la categoría, marca, modelo y el resto de filtros activos.</p>
                    </div>

                    <div class="filter-block" data-filter-block="nombres-servicio">
                        <div class="filter-block-title">Nombres de servicio</div>
                        <div id="filtro-nombre-servicio" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="anio">
                    <div class="filter-section-heading">Año</div>
                    <p class="filter-section-copy">Acota el inventario vehicular por rango de año para encontrar unidades más cercanas a lo que buscas.</p>
                    <div class="filter-block" data-filter-block="anio">
                        <div class="filter-block-title">Rango de año</div>
                ...
                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="condicion">
                    <div class="filter-section-heading">Condición</div>
                    <p class="filter-section-copy">Filtra por estado del vehículo para separar usados, nuevos u otras condiciones registradas.</p>
                    <div class="filter-block" data-filter-block="condicion">
                        <div class="filter-block-title">Condición</div>
                        <div id="filtro-condicion" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="tipo-auto">
                    <div class="filter-section-heading">Tipo de auto</div>
                    <p class="filter-section-copy">Selecciona la categoría vehicular que te interesa dentro de la tienda.</p>
                    <div class="filter-block" data-filter-block="tipo-auto">
                        <div class="filter-block-title">Tipo de auto</div>
                        <div id="filtro-tipo-auto" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="color">
                    <div class="filter-section-heading">Color</div>
                    <p class="filter-section-copy">Reduce los resultados por color disponible para cada unidad.</p>
                    <div class="filter-block" data-filter-block="color">
                        <div class="filter-block-title">Color</div>
                        <div id="filtro-color" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="tapiceria">
                    <div class="filter-section-heading">Tapicería</div>
                    <p class="filter-section-copy">Encuentra vehículos según el acabado interior que más te conviene.</p>
                    <div class="filter-block" data-filter-block="tapiceria">
                        <div class="filter-block-title">Tapicería</div>
                        <div id="filtro-tapiceria" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="climatizacion">
                    <div class="filter-section-heading">Climatización</div>
                    <p class="filter-section-copy">Filtra por sistema de climatización disponible en los vehículos publicados.</p>
                    <div class="filter-block" data-filter-block="climatizacion">
                        <div class="filter-block-title">Climatización</div>
                        <div id="filtro-climatizacion" class="filter-list-grid"></div>
                    </div>
                </section>

                <section class="filter-detail-panel vehicle-filter-panel" data-filter-panel="referencia">
                    <div class="filter-section-heading">Referencia</div>
                    <p class="filter-section-copy">Filtra por referencias asociadas a los vehÃ­culos disponibles en esta empresa.</p>
                    <div class="filter-block" data-filter-block="referencia">
                        <div class="filter-block-title">Referencia</div>
                        <div id="filtro-referencias" class="filter-list-grid"></div>
                    </div>
                </section>
...
<script src="js/productos_vendor.js?v1.1.3 "></script>
