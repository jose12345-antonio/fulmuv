...
<aside class="filter-panel-modern" id="panelFiltros" aria-hidden="true">
    <div class="filter-panel-header">
        <div>
            ...
            <p class="filter-panel-subtitle">Busca, ordena y ajusta la ubicacion sin cubrir el grid.</p>
        </div>
...
<div class="container-fluid mt-3">
    ...
    <div class="vendor-grid" id="listaVendedoresContainer"></div>
...
?>
<script src="js/vendor.js?v1.0.1.0.0.26"></script>
