    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Atributos</h5>
            </div>
        </div>
    </div>
            ...
            <table class="table table-sm mb-0 data-table fs-10" id="my_table">
                <thead class="bg-200">
                    <tr>
                        ...
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap">Tipo Dato</th>
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap">Opciones</th>
