...
<div class="card mt-3">
    <div class="card-body">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <?php if ($id_producto != "") { ?>
                    <button onclick="verificarMembresiaYEditar()" class="btn btn-primary" id="btnActualizarProducto" role="button">Actualizar producto </button>
                <?php } else { ?>
                    <button onclick="verificarMembresiaYGuardar()" class="btn btn-primary" id="btnGuardarProducto" role="button">Registrar producto </button>
                <?php } ?>
...
<!-- Conexión API js -->
<script src="js/crear_producto.js?v2.0.0.0.0.1.21"></script>
<!-- Alerts js -->
