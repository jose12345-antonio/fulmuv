...
<div class="card mb-3">
    ...
    <div class="card-header">
        ...
        <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0">Categorias Principales</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                <div id="table-customers-replace-element">
                    <button onclick="addCategorias()" class="btn btn-falcon-default btn-sm" type="button">
...
<!-- Conexión API js -->
<script src="js/categorias_principales.js"></script>
<!-- Alerts js -->
