              ...
              $("#lista_productos").append(`
                <tr class="border-200">
                  ...
                  <td class="d-flex align-items-center">
                    <a>
                      <img class="img-fluid rounded-1 me-3 d-none d-md-block" src="../${producto.imagen}" alt="" width="60">
                    </a>
                    <div class="flex-1">
                      <h6 class="mb-0 text-nowrap">${producto.nombre}</h6>
                    </div>
                  </td>
                  <td class="align-middle text-center">${producto.peso}</td>
                  <td class="align-middle text-center">${producto.cantidad}</td>
                  <td class="align-middle text-center">
                    ${pesoTot}
                  </td>
                  <td class="align-middle text-end carrito">$${producto.precio.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                </tr>
              `);
            });
