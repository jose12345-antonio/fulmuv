...
<style>
    ...
    .home-slider #listInsertBanner,
    .home-slider #listInsertBanner .slick-list,
    .home-slider #listInsertBanner .slick-track,
    .home-slider #listInsertBanner .slick-slide {
        min-height: 420px;
    }
...
<section class="popular-categories section-padding mb-30 py-3 d-none" style="background-color: rgba(0, 96, 112, 0.09);">
...
<section class="section-padding pb-5 py-0 mb-30">
    <div class="container">
        <div class="section-title wow animate__animated animate__fadeIn mb-2">
            <div class="title">
                <a href="productos_vendidos_hoy.php">
            ...
            <div class="col-lg-2 d-none d-lg-flex wow animate__animated animate__fadeIn">
                ...
                background-size: cover; background-position: center; height: 300px;">
                    ...
                    <div class="p-2">
                        ...
                        <a href="productos_vendidos_hoy.php" class="btn btn-md btn-light">Compra ahora <i class="fi-rs-arrow-small-right"></i></a>
                    </div>
...
<section class="section-padding pb-5 mb-30">
    <div class="container p-0">
        <div class="w-100">
            <img alt="Publicidad" class="img-fluid w-100" style="max-height: 600px; object-fit: fill;" id="imgpublicidad">
        </div>
    </div>
</section>
...
<section class="product-tabs section-padding position-relative mb-30" style="background-color: rgba(0, 96, 112, 0.09);">
    <div class="container">
        <div class="section-title wow animate__animated animate__fadeIn mb-2">
            <div class="title">
                <a href="ofertas_imperdibles.php">
...
<section class="section-padding pb-5 mb-30">
    <div class="container p-0">
        <div class="w-100">
            <img alt="Publicidad" class="img-fluid w-100" style="max-height: 600px; object-fit: fill;" id="imgpublicidad2">
        </div>
    </div>
</section>
...
<section class="section-padding pb-5 mb-30" style="background-color: rgba(0, 96, 112, 0.09);">
    <div class="container">
        <div class="section-title wow animate__animated animate__fadeIn mb-2">
            <div class="title">
                <a href="productos_categoria.php?q=2">
...
<section class="section-padding pb-5 mb-30" id="section-eventos">
    <div class="container">
        <div class="section-title wow animate__animated animate__fadeIn mb-2">
            <div class="title">
                <a href="eventos.php">
        ...
        <div class="tab-content" id="myTabContent-1">
            <div class="tab-pane fade show active" id="tab-one-1" role="tabpanel" aria-labelledby="tab-one-1">
                <div class="carausel-4-columns-cover arrow-center position-relative">
                    <div class="slider-arrow slider-arrow-2 carausel-4-columns-arrow" id="carausel-4-columns-arrows-eventos"></div>
...
<section class="section-padding pb-5 mb-30" id="section-empleos" style="background-color: rgba(0, 96, 112, 0.09);">
    <div class="container">
        <div class="section-title wow animate__animated animate__fadeIn mb-2">
            <div class="title">
                <a href="empleos.php">
        ...
        <div class="tab-content" id="myTabContent-1">
            <div class="tab-pane fade show active" id="tab-one-1" role="tabpanel" aria-labelledby="tab-one-1">
                <div class="carausel-4-columns-cover arrow-center position-relative">
                    <div class="slider-arrow slider-arrow-2 carausel-4-columns-arrow" id="carausel-4-columns-arrows-empleos"></div>
...
<script>
        ...
        $.get("api/v1/fulmuv/getProductosVendidosHoy/", function(returnedData) {
            if (!returnedData.error) {
                ...
                const renderLista = (items) => {
                                    ...
                                    <div class="text-center">
                                        <div class="vendor-img-action-wrap">
                                            <div class="vendor-img d-flex justify-content-center align-items-center">
                                                <a href="productos_vendor.php?q=4">
                                                    <img class="default-img" src="admin/${data.img_frontal}" alt="" 
                                                        onerror="this.onerror=null;this.src='img/FULMUV-NEGRO.png';" 
                                                        style="height: 150px; object-fit: contain;" />
                                                </a>
                                        ...
                                        <h4 class="my-2 text-dark text-center" style="font-size: 16px;">
                                            <a href="detalle_productos.php?q=${data.id_producto}" class="text-center">${capitalizarPrimeraLetra(data.titulo_producto)}</a>
                                        </h4>
                                    </div>
                    ...
                    $slider.slick(buildHomeCarouselConfig("#carausel-4-columns-arrows"));
                };

                const base = returnedData.data || [];
                const seleccion = pickWithMembresiaFallback(base, "id_producto", 10, base);

                if (seleccion.length) {
                    renderLista(seleccion);
                } else {
                    $.get("api/v1/fulmuv/productosAll/all", function(fallback) {
                        const fb = fallback?.data || [];
                        const fbSeleccion = pickWithMembresiaFallback(fb, "id_producto", 10, fb);
                        renderLista(fbSeleccion);
                    }, "json");
                }
            }
        }, 'json');
        ...
        $.get("api/v1/fulmuv/serviciosProductos/All", function(returnedData) {
            if (!returnedData.error) {
                ...
                if (seleccion.length) {
                    ...
                    $.get("api/v1/fulmuv/getServiciosVendidosHoy/", function(fallback) {
                        const fb = fallback?.data || [];
                        const fbSeleccion = pickWithMembresiaFallback(fb, "id_producto", 10, fb);
                        renderLista(fbSeleccion);
                    }, "json");
        ...
        $.get("api/v1/fulmuv/publicidad/all", function(returnedData) {
            if (!returnedData.error) {
                ...
                returnedData.data.forEach(function(data) {
                    if (data.posicion == "1" || data.posicion == 1) {
                        $("#imgpublicidad").attr("src", "admin/" + data.imagen)
                    }

                    if (data.posicion == "2" || data.posicion == 2) {
                        $("#imgpublicidad2").attr("src", "admin/" + data.imagen)
                    }
                })
    ...
    function cargarProductosOferta() {
        ...
        $.get("api/v1/fulmuv/ofertas_imperdibles/", function(returnedData) {
            if (!returnedData.error) {
                ...
                const base = returnedData.data || [];
                const baseConDesc = base.filter(p => parseFloat(p?.descuento || 0) > 0);
                const seleccion = pickWithMembresiaFallback(baseConDesc, "id_producto", 10, baseConDesc);

                if (seleccion.length) {
                    renderLista(seleccion);
                } else {
                    $.get("api/v1/fulmuv/productosAll/all", function(fallback) {
                        const fb = (fallback?.data || []).filter(p => parseFloat(p?.descuento || 0) > 0);
                        const fbSeleccion = pickWithMembresiaFallback(fb, "id_producto", 10, fb);
                        renderLista(fbSeleccion);
                    }, "json");
                }
    ...
    function cargarProductosGenialParati() {
        ...
        $.get("api/v1/fulmuv/productosAll/all", function(returnedData) {
            if (!returnedData.error) {
                ...
                // 4. Volver a inicializar slick
                $slider.slick(buildHomeCarouselConfig("#carausel-4-columns-arrows-para-ti"));
                };
                ...
                if (seleccion.length) {
                    ...
                    $.get("api/v1/fulmuv/getProductosVendidosHoy/", function(fallback) {
                        const fb = fallback?.data || [];
                        const fbSeleccion = pickWithMembresiaFallback(fb, "id_producto", 10, fb);
                        renderLista(fbSeleccion);
                    }, "json");
            ...
            if (!returnedData.error) {
                ...
                const renderLista = (items) => {
                    ...
                    const verificacion = (Array.isArray(data.verificacion) && data.verificacion[0]?.verificado == 1)
                        ? `<img class="home-vehicle-verify" src="img/verificado_empresa.png" alt="Empresa verificada">`
                        : "";
                ...
                const base = returnedData.data || [];
                const seleccion = pickWithMembresiaFallback(base, "id_vehiculo", 10, base);
                ...
                if (seleccion.length) {
                    ...
                    $.get("api/v1/fulmuv/vehiculos/All", function(fallback) {
                        const fb = fallback?.data || [];
                        const fbSeleccion = pickWithMembresiaFallback(fb, "id_vehiculo", 10, fb);
                        renderLista(fbSeleccion);
                    }, "json");
                }
            }
    ...
    function isMembresiaActiva(item) {
        ...
        const estado = (memb.estado_membresia || "").toString().toUpperCase();
    ...
    function takeRandomUniqueById(items, idKey, limit) {
        const out = [];
        const seen = new Set();
    ...
    function pickWithMembresiaFallback(items, idKey, limit, fallbackItems) {
        const primary = takeRandomUniqueById(filterByMembresiaActiva(items), idKey, limit);
        if (primary.length) return primary;
        const secondary = takeRandomUniqueById(filterByMembresiaActiva(fallbackItems), idKey, limit);
        if (secondary.length) return secondary;
        return takeRandomUniqueById(fallbackItems, idKey, limit);
    }
    ...
    function cargarEventos() {
        ...
        $.get("api/v1/fulmuv/eventos/all", function(returnedData) {
            ...
            const visibles = filterByMembresiaActiva(returnedData.data || []).filter(ev => {
    ...
    function cargarEmpleos() {
        ...
        $.get("api/v1/fulmuv/empleosAll/all", function(returnedData) {
            ...
            const visibles = filterByMembresiaActiva(returnedData.data || []).filter(emp => {
