            ...
            <table class="table table-sm mb-0 data-table fs-10" id="my_table">
                <thead class="bg-200">
                    <tr>
                        ...
                        <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="address" style="min-width: 12.5rem;">Cliente</th>
...
<!-- Conexión API js -->
<script src="js/ordenes.js?v1.0.42"></script>
<!-- Alerts js -->
