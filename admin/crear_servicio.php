                ...
                <form>
                    <div class="row gx-2">
                        <div class="col-12 mb-3">
                            <label class="form-label" for="product-name">Nombre servicio:</label>
...
<div class="card mt-3">
    <div class="card-body">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
                <button onclick="addProducto()" class="btn btn-primary" role="button">Registrar servicio </button>
            </div>
        </div>
    </div>
</div>
<!-- Conexión API js -->
<script src="js/crear_servicio.js?v1.0.0"></script>
<!-- Alerts js -->
