...
<style>
    ...
    @media (max-width: 576px) {
        .empleo-card-image { height: 180px; }
    }
</style>
    ...
    <div class="card-body p-4 p-lg-5">
        <div class="row align-items-center g-4">
            <div class="col-lg-8">
                ...
                <h3 class="mb-2">Gestiona las vacantes</h3>
                <p class="text-700 mb-0">Publica, revisa postulaciones y mantén cada empleo actualizado con una presentación más clara y profesional.</p>
            </div>
...
<div class="card empleos-toolbar-card mb-3">
    <div class="card-body">
        <div class="row g-3 align-items-end">
            <div class="col-lg-8 empleos-search-box">
...
<!-- Conexión API js -->
<script src="js/empleos.js?admin1.0"></script>
<!-- Alerts js -->
