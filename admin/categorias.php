  ...
  <div class="card-header">
    <div class="row flex-between-center">
      <div class="col-auto d-flex align-items-center">
        <h5 class="fs-9 mb-0 text-nowrap py-2 py-xl-0"><i class="fas fa-sitemap me-2 text-primary"></i>Categorías</h5>
      </div>
      ...
      <table class="table table-hover table-sm mb-0 fs-10" id="my_table">
        <thead class="bg-200">
          <tr>
            ...
            <th class="text-900 align-middle py-2">Tipo</th>
            <th class="text-900 align-middle py-2 text-end pe-3" style="width:140px">Acciones</th>
          </tr>
        </thead>
