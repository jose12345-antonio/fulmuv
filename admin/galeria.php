...
<style>
  ...
  .gallery-toolbar-title{ font-size: 1.1rem; font-weight: 800; color: #0f172a; }
  .gallery-toolbar-text{ font-size: .88rem; color: #64748b; margin-bottom: 0; }
  .gallery-list-shell{
    border-radius: 18px;
    border: 1px solid #e6edf3;
  ...
  .gallery-body { padding: 1rem 1rem 1.05rem; }
  ...
  .gallery-click-hint{ margin-top: .6rem; font-size: .75rem; color:#94a3b8; }
  .gallery-form-shell{
    background: linear-gradient(180deg,#ffffff 0%,#f8fafc 100%);
    border: 1px solid #e6edf3;
    border-radius: 18px;
  ...
  .gallery-preview-meta{ font-size: .76rem; color: #64748b; margin-top: 8px; }
  .gallery-description-lg{ min-height: 124px; resize: vertical; font-size: 1rem; line-height: 1.65; }
  .gallery-upload-box{
  ...
  .gallery-loading-btn .spinner-border{ width: 1rem; height: 1rem; border-width: .16em; }
  .modal-gallery-fix .modal-content{ background: #020617; }
  #lightboxModal .modal-body{ min-height: calc(100vh - 160px); }
</style>
<title>Galería</title>
        ...
        <div class="d-lg-flex justify-content-between">
            <div class="row flex-between-center">
                <div class="col-md-auto">
                    ...
                    <p class="gallery-toolbar-text">Administra las imágenes de la empresa seleccionada.</p>
                </div>
            </div>
            <div class="row flex-between-center">
                <div class="col-auto">
...
<!-- Conexión API js -->
<script src="js/galeria.js?admin1.0"></script>
<!-- Alerts js -->
