...
if (isset($_POST['id_usuario'])) {
    ...
    if ($_SESSION["rol_id"] == 2 || $_SESSION["rol_id"] == 3) {
        $_SESSION["dashboard"] = "empresa_detalle.php?id_empresa=" . $_POST["id_empresa"];
        header("Location: empresa_detalle.php?id_empresa=" . $_POST["id_empresa"]);
    } else {
        session_unset();
        session_destroy();
    ...
    if ($acceso && $username_new) {
        echo '<input type="hidden" id="acceso" value="' . $acceso . '">';
        echo '<input type="hidden" id="username_new" value="' . $username_new . '">';
        echo $username_new;
    }
}
?>
...
<body>
    ...
    <!-- Conexión API js -->
    <script src="js/login.js?v1.0.44"></script>
