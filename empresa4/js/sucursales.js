      ...
      returned.data.forEach(sucursal => {
        $("#lista_sucursales").append(`
          <tr class="btn-reveal-trigger">
              ...
              <td class="email  py-2">${sucursal.direccion}</td>
              <td class="phone   py-2">${sucursal.empresa}</td>
              <td class="address  ">${sucursal.created_at}</td>
...
function saveSucursal() {
  ...
  if (nombre == "" || provincia == "" || canton == "" || telefono_contacto == "" || whatsapp_contacto == "" || calle_principal == "" || calle_secundaria == "" || bien_inmueble == "" || correo == "") {
    ...
    SweetAlert("success", "TODO CORRECTO")
    console.log(nombre, provincia, canton, telefono_contacto, whatsapp_contacto, calle_principal, calle_secundaria, bien_inmueble, correo, latitud, longitud)
...
function updateSucursalFull() {
  ...
  for (const k of ["nombre","provincia","canton","telefono_contacto","whatsapp_contacto","correo","calle_principal","calle_secundaria","bien_inmueble"]) {
