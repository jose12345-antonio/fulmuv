...
<link rel="canonical" href="https://fulmuv.com/servicios.php">
    ...
    <div class="row flex-row-reverse" style="transform: none;">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar fulmuv-sidebar-col" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
            ...
            <div class="fulmuv-filter-panel" id="mobileFilters">
                <div class="accordion fulmuv-filter-accordion mt-30" id="filtersAccordionServicios">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarcaServicios">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMarcaServicios" aria-expanded="true" aria-controls="collapseMarcaServicios">
                                Marca
                            </button>
                        </h2>
                        <div id="collapseMarcaServicios" class="accordion-collapse collapse show" aria-labelledby="headingMarcaServicios" data-bs-parent="#filtersAccordionServicios">
                            <div class="accordion-body"><div id="filtro-marca"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingModeloServicios">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseModeloServicios" aria-expanded="false" aria-controls="collapseModeloServicios">
                                Modelo
                            </button>
                        </h2>
                        <div id="collapseModeloServicios" class="accordion-collapse collapse" aria-labelledby="headingModeloServicios" data-bs-parent="#filtersAccordionServicios">
                            <div class="accordion-body"><div id="filtro-modelo"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingCategoriasServicios">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCategoriasServicios" aria-expanded="false" aria-controls="collapseCategoriasServicios">
                                Categorías
                            </button>
                        </h2>
                        <div id="collapseCategoriasServicios" class="accordion-collapse collapse" aria-labelledby="headingCategoriasServicios" data-bs-parent="#filtersAccordionServicios">
                            <div class="accordion-body"><div id="filtro-categorias"></div></div>
                        </div>
                    </div>
                    <div id="subcats-box" class="accordion-item" style="display:none;">
                        <h2 class="accordion-header" id="headingSubcategoriasServicios">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSubcategoriasServicios" aria-expanded="false" aria-controls="collapseSubcategoriasServicios">
                                Sub categorías
                            </button>
                        </h2>
                        <div id="collapseSubcategoriasServicios" class="accordion-collapse collapse" aria-labelledby="headingSubcategoriasServicios" data-bs-parent="#filtersAccordionServicios">
                            <div class="accordion-body"><div id="filtro-sub-categorias"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingNombresServicios">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNombresServicios" aria-expanded="false" aria-controls="collapseNombresServicios">
                                Nombres de servicio
                            </button>
                        </h2>
                        <div id="collapseNombresServicios" class="accordion-collapse collapse" aria-labelledby="headingNombresServicios" data-bs-parent="#filtersAccordionServicios">
                            <div class="accordion-body"><div id="filtro-nombre-servicio"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingPrecioServicios">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePrecioServicios" aria-expanded="false" aria-controls="collapsePrecioServicios">
                                Filtrar por precio
                            </button>
                        </h2>
                        <div id="collapsePrecioServicios" class="accordion-collapse collapse" aria-labelledby="headingPrecioServicios" data-bs-parent="#filtersAccordionServicios">
