...
<head>
    ...
    <style>
        ...
        /* Sub-secciones del panel Usuario/Facturación/Pago */
        .psp-subsection {
            margin-bottom: 18px;
        }

        .psp-subsection:last-child {
            margin-bottom: 0;
        }

        .psp-subsection + .psp-subsection {
            padding-top: 16px;
            border-top: 1px dashed rgba(148, 163, 184, 0.35);
        }

        .psp-subsection-header {
            display: flex;
            align-items: center;
            gap: 7px;
            margin-bottom: 12px;
        ...
        .plan-detail-row + .plan-detail-row {
            border-top: 1px solid rgba(148, 163, 184, 0.14);
        }

        .plan-detail-row.is-separator {
            border-top: 1px dashed rgba(148, 163, 184, 0.35) !important;
            background: #f8fafc;
        }

        .plan-detail-row.is-highlight {
            background: linear-gradient(90deg, rgba(0,78,96,0.06) 0%, rgba(15,118,110,0.04) 100%);
        }

        .plan-detail-row.is-today {
            background: linear-gradient(90deg, rgba(0,104,111,0.10) 0%, rgba(15,118,110,0.07) 100%);
        }
        ...
        .plan-detail-val.is-primary {
            color: #004e60;
        }

        .plan-detail-val.is-promo {
            color: #059669;
        }

        .plan-detail-val.is-muted {
            color: #64748b;
            font-weight: 600;
            font-size: 12px;
        }

        .plan-detail-code-badge {
            display: inline-flex;
            align-items: center;
            gap: 5px;
            background: #ecfdf5;
        ...
        .plan-card--popular {
            ...
            box-shadow: 0 20px 48px rgba(0, 104, 111, .18);
        }

        .plan-card__popular-bar {
            background: linear-gradient(135deg, #004e60 0%, #0f766e 100%);
            color: #ffffff;
            text-align: center;
            font-size: 13px;
        ...
        .plan-card__btn--popular {
            background: linear-gradient(135deg, #004e60 0%, #0f766e 100%);
            color: #ffffff;
            border-color: transparent;
            box-shadow: 0 8px 22px rgba(0, 78, 96, .28);
        }

        .plan-card__btn--popular:hover {
            background: linear-gradient(135deg, #003d4d 0%, #0c5a58 100%);
            color: #ffffff;
        }
        ...
        .suc-toggle-label:hover {
            border-color: #00686f;
            background: #f0faf9;
        }

        .suc-toggle-input:checked + .suc-toggle-label {
            border-color: #00686f;
            background: #e6f7f6;
            box-shadow: 0 0 0 3px rgba(0, 104, 111, .12);
        }
        ...
        .suc-toggle-input:checked + .suc-toggle-label .suc-toggle-icon {
            background: #00686f;
            border-color: #00686f;
            color: #ffffff;
        }
        ...
        .suc-toggle-input:checked + .suc-toggle-label .suc-toggle-check {
            background: #00686f;
            border-color: #00686f;
        }

        .suc-toggle-input:checked + .suc-toggle-label .suc-toggle-check-icon {
            opacity: 1;
        }

        /* Col wrapper FULMUV */
        .membresia-col-fulmuv {
            z-index: 3;
        }

        /* Wrapper */
        .membresia-carousel-wrapper {
            padding: 10px 0 12px;
        }
        ...
        @media (max-width: 767.98px) {
            ...
            .membresia-grid > [class*="col-"].membresia-tab-active {
                display: flex !important;
            }
        }

        /* Tab nav (solo visible en móvil) */
        .membresia-tab-nav {
            display: none;
        }
        ...
        .membresia-tab-btn.is-active {
            background: #fff;
            color: #0f172a;
            box-shadow: 0 1px 6px rgba(0,0,0,.10);
        }

        .membresia-tab-btn.is-fulmuv.is-active {
            background: linear-gradient(135deg, #004e60 0%, #0f766e 100%);
            color: #fff;
            box-shadow: 0 4px 12px rgba(0,104,111,.28);
        }
...
<body>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-12 mb-4">
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="fs-8 mb-0">Inversión mínima, multiplicación máxima. Está en ti.<br />Planes para particulares, empresas y negocios.</h4>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="membresia-tab-nav d-md-none" id="membresiaTabNav" aria-label="Planes de membresia"></div>
                                                <div class="membresia-carousel-wrapper">
                                                    <div id="contenedor-membresias" class="row justify-content-center align-items-stretch membresia-grid"></div>
                                                </div>
                                                <!-- Carrusel móvil: flechas + dots -->
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="payment-payment-grid">
                                                <div>
                                                        <div class="payment-payment-box">
                                                            ...
                                                            <div class="wallet-sdk-badge mb-3">
                                                                <span class="wallet-sdk-badge-logo">
                                                                    <img src="files/Nuvei_Organization_logo.png" alt="Nuvei">
                                                                </span>
                                                                <span class="wallet-sdk-badge-copy">
                                                                    <strong>Pagos protegidos con Nuvei</strong>
                                                                    <span>Ingresa los datos en el formulario seguro de Paymentez. Por tu seguridad, la informacion sensible de la tarjeta no se almacena en este panel.</span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="payment-consent">
                                                        <div class="form-check mt-0">
                                                            ...
                                                            <label class="form-check-label mb-0" for="checkTerminoCondicionesPago">
                                                                ...
                                                                <p class="mt-2 mb-0"><a href="../documentos/4_Condiciones%20Pago%20en%20L%C3%ADnea%20de%20FULMUV.pdf" target="_blank" class="fs-10 fw-bold">
    ...
    <!-- Conexión API js -->
    <script src="js/crear_empresa.js?v2.1.5"></script>
