              ...
              <div class="p-4">
                ...
                <div class="row g-3">
                  <div class="col-md-7">
                    ...
                    <textarea class="form-control gallery-description-lg" id="edit_descripcion" style="height: 300px;" maxlength="300" placeholder="Describe mejor esta imagen para que sea más clara visualmente.">${$('<div>').text(descripcion).html()}</textarea>
                  </div>
                  <div class="col-md-5">
            ...
            <div class="p-4">
              ...
              <div class="row g-3">
                <div class="col-md-7">
                  ...
                  <textarea class="form-control gallery-description-lg" id="descripcion" style="height: 300px;" placeholder="Agrega una descripción más completa para esta imagen de galería."></textarea>
                </div>
                <div class="col-md-5">
