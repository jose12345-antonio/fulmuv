$(document).ready(function () {
  ...
  $.get('../api/v1/fulmuv/nombres_productos/', {}, function (returnedData) {
    ...
    if (returned.error == false) {
      ...
      returned.data.forEach(nombres => {
        console.log(nombres.nombre)
        $("#lista_categorias").append(`
          <tr class="btn-reveal-trigger">
            <td class="py-2 align-middle fs-9 fw-medium">${nombres.nombre}</td>
            <td class="py-2 align-middle fs-9 fw-medium">${nombres.categoria}</td>
            <td class="py-2 align-middle fs-9 fw-medium">${nombres.sub_categoria}</td>
            ...
            <!--td class="align-middle white-space-nowrap py-2 text-end">
              <div class="dropdown font-sans-serif position-static">
                ...
                <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                  <div class="py-2">
                    <a class="dropdown-item text-danger" onclick="remove(${nombres.id_nombre_producto}, 'categorias')">Eliminar</a>
                  </div>
                </div>
              </div>
            </td-->
