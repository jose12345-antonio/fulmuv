...
/* Select2 full width dentro de tarjeta */
.veh-card .select2-container { width: 100% !important; }
.select2-container { z-index: 99999 !important; }
.select2-dropdown  { z-index: 99999 !important; }

/* Checkbox estilo limpio */
.veh-card input[type="checkbox"].chk_publicar {
  width: 15px; height: 15px; cursor: pointer; accent-color: #16a34a;
}
...
/* SweetAlert scroll */
.sweet-alert p {
  max-height: 40vh; overflow-y: auto; padding-right: 10px; text-align: center !important;
}
...
<div class="card shadow mb-3 carga-masiva-vehiculos">
  <div class="card-header d-flex flex-wrap gap-2 align-items-center">
    <h5 class="mb-0 me-auto">Carga Masiva — Vehículos</h5>
    ...
    <div class="cmv-search-wrap" style="min-width:310px;">
      ...
      <input type="text" id="buscadorBorrador"
             class="form-control"
             placeholder="Buscar borrador (marca, modelo, tipo…)">
    </div>
...
<script src="js/carga_masiva_vehiculos.js?v2.0.0"></script>
