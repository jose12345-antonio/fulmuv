...
<title>Carga Masiva Productos</title>
...
<div class="card shadow mb-3 carga-masiva-productos">
  <div class="card-header d-flex flex-wrap gap-2 align-items-center">
    <h5 class="mb-0 me-auto">Carga Masiva — Productos</h5>

    <div class="cmv-search-wrap" style="min-width:310px;">
      <i class="fa-solid fa-magnifying-glass"></i>
      <input type="text" id="buscadorBorrador"
             class="form-control"
             placeholder="Buscar borrador (título, código, marca…)">
    </div>
...
<script src="js/carga_masiva_productos.js?v2.0.0"></script>
