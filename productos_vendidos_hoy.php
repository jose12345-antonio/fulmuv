    ...
    <div class="row flex-row-reverse" style="transform: none;">
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar fulmuv-sidebar-col" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
            ...
            <div class="fulmuv-filter-panel" id="mobileFilters">
                <div class="accordion fulmuv-filter-accordion mt-30" id="filtersAccordionVendidos">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingMarcaVendidos">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMarcaVendidos" aria-expanded="true" aria-controls="collapseMarcaVendidos">
                                Marca
                            </button>
                        </h2>
                        <div id="collapseMarcaVendidos" class="accordion-collapse collapse show" aria-labelledby="headingMarcaVendidos" data-bs-parent="#filtersAccordionVendidos">
                            <div class="accordion-body"><div id="filtro-marca"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingModeloVendidos">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseModeloVendidos" aria-expanded="false" aria-controls="collapseModeloVendidos">
                                Modelo
                            </button>
                        </h2>
                        <div id="collapseModeloVendidos" class="accordion-collapse collapse" aria-labelledby="headingModeloVendidos" data-bs-parent="#filtersAccordionVendidos">
                            <div class="accordion-body"><div id="filtro-modelo"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingCategoriasVendidos">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCategoriasVendidos" aria-expanded="false" aria-controls="collapseCategoriasVendidos">
                                Categorías
                            </button>
                        </h2>
                        <div id="collapseCategoriasVendidos" class="accordion-collapse collapse" aria-labelledby="headingCategoriasVendidos" data-bs-parent="#filtersAccordionVendidos">
                            <div class="accordion-body"><div id="filtro-categorias"></div></div>
                        </div>
                    </div>
                    <div id="subcats-box" class="accordion-item" style="display:none;">
                        <h2 class="accordion-header" id="headingSubcategoriasVendidos">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSubcategoriasVendidos" aria-expanded="false" aria-controls="collapseSubcategoriasVendidos">
                                Sub categorías
                            </button>
                        </h2>
                        <div id="collapseSubcategoriasVendidos" class="accordion-collapse collapse" aria-labelledby="headingSubcategoriasVendidos" data-bs-parent="#filtersAccordionVendidos">
                            <div class="accordion-body"><div id="filtro-sub-categorias"></div></div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingPrecioVendidos">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePrecioVendidos" aria-expanded="false" aria-controls="collapsePrecioVendidos">
                                Filtrar por precio
                            </button>
                        </h2>
                        <div id="collapsePrecioVendidos" class="accordion-collapse collapse" aria-labelledby="headingPrecioVendidos" data-bs-parent="#filtersAccordionVendidos">
