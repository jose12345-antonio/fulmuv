...
if (isset($_SESSION["id_usuario"])) {
    ...
    echo '<input type="hidden" class="form-control" name="id_usuario" id="id_usuario" value="' . $_SESSION["id_usuario"] . '" required>';
}
?>
...
<script src="js/mi_cuenta.js?v1.0.0.0.2"></script>