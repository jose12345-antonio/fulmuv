    ...
    <div class="filter-panel-body">
        <div class="filter-layout-modern">
            <div class="filter-nav-modern">
                ...
                <button type="button" class="filter-nav-item" data-filter-target="caracteristicas">
                    <span class="filter-nav-label">Características</span>
                    <span class="filter-nav-meta" id="filterGroupCountSpecs">0</span>
                </button>
            </div>
            <div class="filter-content-modern">
                ...
                <section class="filter-detail-panel" data-filter-panel="caracteristicas">
                    <div class="filter-section-heading">Características</div>
                    <p class="filter-section-copy">Filtra por marca, modelo, precio, año y atributos del vehículo sin salir del panel.</p>
                    ...
                    <div class="filter-block">
                        <div class="filter-block-title">Año</div>
