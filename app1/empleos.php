...
<style>
    ...
    /* Todas las imágenes del card con mismo alto y centradas */
...
<div class="container jobs-shell">
    <section class="jobs-hero">
        ...
        <p>Explora vacantes activas, filtra por ubicación y postúlate desde una vista más clara, rápida y pensada para móvil, tablet y app.</p>
    </section>
                    ...
                    <div class="col-lg-7 right-pane">
                        ...
                        <div class="right-body">
                            ...
                            <?php if ($sinCuentaMode): ?>
                                <div class="job-login-alert mb-3">
                                    <strong>Debe iniciar sesión para poder aplicar</strong>
                                    <p>Ingresa con tu cuenta para postularte a este empleo, cargar tu hoja de vida y dar seguimiento a tus solicitudes dentro de Fulmuv.</p>
                                </div>
                            <?php endif; ?>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                            ...
                                            <small class="text-muted align-self-center">PDF, DOC o DOCX. Tamaño recomendado: hasta 5MB.</small>
                                        </div>
                                    </div>
...
<script>
                ...
                <div class="card card-empleo h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-muted small mb-3">
                            ${ev.descripcion ? ev.descripcion.replace(/<[^>]+>/g, '').substring(0, 100) + '...' : 'Sin descripción disponible.'}
                        </p>
    ...
    function isEmpleoVigente(ev) {
        ...
        // Si no tiene fecha de fin, asumimos que está activo
