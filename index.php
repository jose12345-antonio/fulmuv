                                ...
                                <div class="vendor-wrap h-100 d-flex flex-column justify-content-between">
                                    <div class="text-center">
                                        ...
                                        <h4 class="my-2 text-dark text-center" style="font-size: 16px;">
                                            <a href="detalle_productos.php?q=${data.id_producto}" target="_blank" rel="noopener noreferrer" class="text-center"
                                                onclick="irADetalleProductoConTerminos(${data.id_producto}); return false;">${capitalizarPrimeraLetra(data.titulo_producto)}</a>
                                        </h4>
                                    </div>
