...
$app->get('/fulmuv/validarMembresiaProductos/{id}/{tipo}', function ($request, $response, $args) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->validarMembresiaProductos($id_empresa, $tipo);
...
$app->post('/fulmuv/empresas/update', function ($request, $response) {
    ...
    $resultado = $db->updateEmpresa($id_empresa, $nombre, $nombre_titular, $provincia, $canton, $calle_principal, $calle_secundaria, $bien_inmueble, $whatsapp_contacto, $telefono_contacto, $correo, $img_path, $tipo_user);
...
$app->post('/fulmuv/empresas/membresiasUpdate', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->membresiasUpdate($id_empresa, $id_membresia, $id_usuario, $pago_valor, $tipo, $transaction_id, $authorization_code, $recurrente, $payment_date, $valor_membresia);
...
$app->post('/fulmuv/sucursales/create', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->createSucursal($id_empresa, $nombre, $provincia, $canton, $telefono_contacto, $whatsapp_contacto, $calle_principal, $calle_secundaria, $bien_inmueble, $latitud, $longitud, $correo);
    if ($resultado == RECORD_CREATED_SUCCESSFULLY) {
        $response["error"] = false;
        $response["msg"] = "La sucursal ha sido creado con éxito.";
    } else if ($resultado == RECORD_ALREADY_EXISTED) {
        $response["error"] = true;
        $response["msg"] = "La sucursal ya existe. Verifique nuevamente los datos";
...
$app->post('/fulmuv/sucursales/init_pago', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->createSucursalPago($id_empresa, $nombre, $provincia, $canton, $telefono_contacto, $whatsapp_contacto, $calle_principal, $calle_secundaria, $bien_inmueble, $token, $monto);
...
$app->get('/fulmuv/categorias/', function ($request, $response, $args) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->getCategorias($tipo);
    $response["error"] = false;
    $response["data"] = $resultado;
    echo json_encode($response);
});
...
$app->post('/fulmuv/sub_categorias/delete', function ($request, $response) {
    ...
    if ($resultado == RECORD_UPDATED_SUCCESSFULLY) {
        $response["error"] = false;
        $response["msg"] = "Subcategoria eliminada correctamente.";
    } else {
        $response["error"] = true;
        $response["msg"] = "Ocurrió un error!";
    }
...
$app->get('/fulmuv/getNombreProductoById/{id}', function ($request, $response, $args) {
    $id_nombre_producto = $args['id'];
    $response = array();
    $db = new DbHandler();
    $resultado = $db->getNombreProductoById($id_nombre_producto);
    $response["error"] = false;
    $response["data"] = $resultado;
    echo json_encode($response);
});
...
$app->get('/fulmuv/getNombreServicioById/{id}', function ($request, $response, $args) {
    $id_nombre_servicio = $args['id'];
    $response = array();
    $db = new DbHandler();
    $resultado = $db->getNombreServicioById($id_nombre_servicio);
    $response["error"] = false;
    $response["data"] = $resultado;
    echo json_encode($response);
});
...
$app->post('/fulmuv/updateAtributo', function ($request, $response) {
    ...
    if ($resultado == RECORD_UPDATED_SUCCESSFULLY) {
        $response["error"] = false;
        $response["msg"] = "Atributo actualizado correctamente.";
    } else {
        $response["error"] = true;
        $response["msg"] = "Ocurrió un error!";
    }
...
$app->post('/fulmuv/updateFileEmpresa', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->updateFileEmpresa($id_empresa, $titulo, $descripcion);
...
$app->post('/fulmuv/banner/create', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->createBanner($imagen);
...
$app->post('/fulmuv/banner/update', function ($request, $response) {
    ...
    $imagen = $request->getParsedBody()['imagen'];
    $id = $request->getParsedBody()['id_banner'];

    $response = array();
    $db = new DbHandler();
    $resultado = $db->updateBanner($imagen, $id);
...
$app->post('/fulmuv/publicidad/create', function ($request, $response) {
    ...
    $response = array();
    $db = new DbHandler();
    $resultado = $db->createPublicidad($imagen);
...
$app->post('/fulmuv/publicidad/update', function ($request, $response) {
    ...
    $imagen = $request->getParsedBody()['imagen'];
    $id = $request->getParsedBody()['id_publicidad'];

    $response = array();
    $db = new DbHandler();
    $resultado = $db->updatePublicidad($imagen, $id);
...
$app->post('/fulmuv/eventos/update', function ($request, $response) {
    ...
    $tipo = $request->getParsedBody()['tipo'];
    $imagen = $request->getParsedBody()['imagen'];
    $fecha_hora_inicio = $request->getParsedBody()['fecha_hora_inicio'];
    $fecha_hora_fin = $request->getParsedBody()['fecha_hora_fin'];
    $id = $request->getParsedBody()['id'];

    $response = array();
    $db = new DbHandler();
    $resultado = $db->updateEvento($titulo, $descripcion, $tipo, $imagen, $fecha_hora_inicio, $fecha_hora_fin, $id);
...
$app->get('/fulmuv/eventos/{id}', function ($request, $response, $args) {
    ...
    $response = array();
    $db = new DbHandler();
    $estados_historico = $db->getEventoById($id);
    $response["error"] = false;
    $response["data"] = $estados_historico;
    echo json_encode($response);
});
...
$app->post('/fulmuv/refund/pago/', function ($request, $response) {
    $response = array();
    $id_transaccion = $request->getParsedBody()['id_transaccion'];

    $db = new DbHandler();
    $resultado = $db->reembolsar($id_transaccion);

    if ($resultado == 'success_update_all') {
        $response["error"] = false;
        $response["msg"] = "Reembolso exitoso! La suscripcion y la venta han sido anuladas";
    } elseif ($resultado == 'success_update') {
        $response["error"] = false;
        $response["msg"] = "Reembolso exitoso! La suscripcion fue anulada pero no se puedo anular la venta";
    } elseif ($resultado == 'success') {
        $response["error"] = false;
        $response["msg"] = "Reembolso exitoso, pero no se pudo anular la suscripcion y la venta.";
    } elseif (array_key_exists("status", $resultado)) {
        $response["error"] = true;
        $response["msg"] = "Ocurrió un error al hacer el reembolso, intentalo mas tarde.\n Status: " . $resultado["status"] . "\n Nuvei: " . $resultado["detail"];
    } elseif ($resultado == 'error') {
        $response["error"] = true;
...
$app->post('/fulmuv/membresias/upgrade', function ($request, $response) {
    ...
    $id_membresia = $request->getParsedBody()['id_membresia'];
    $valor = $request->getParsedBody()['valor'];
    $sucursales = $request->getParsedBody()['sucursales'];

    $response = array();
    $db = new DbHandler();
    $resultado = $db->upgradeMembresia($id_empresa, $id_membresia, $valor, $sucursales);
...
$app->get('/fulmuv/empresa/tokens/{id_empresa}', function ($request, $response, $args) {
    $id_empresa = $args['id_empresa'];
    $db = new DbHandler();
    $tarjetas = $db->getTarjetasByEmpresa($id_empresa);
...
$app->post('/fulmuv/clientes/registro', function ($request, $response) {
    ...
    if ($resultado == RECORD_CREATED_SUCCESSFULLY) {
        $res_api["error"] = false;
        $res_api["msg"] = "¡Registro exitoso! Ya puedes iniciar sesión.";
    } else if ($resultado == USER_ALREADY_EXISTED) {
        $res_api["error"] = true;
        $res_api["msg"] = "El correo electrónico ya se encuentra registrado.";
    } else if ($resultado == USER_CEDULA_ALREADY_EXISTED) {
        $res_api["error"] = true;
        $res_api["msg"] = "El número de cédula ya está vinculado a otra cuenta.";
    } else {
        $res_api["error"] = true;
        $res_api["msg"] = "Ocurrió un error inesperado al procesar tu registro.";
    }
...
$app->post('/fulmuv/archivos_productos/delete', function ($request, $response) {
    // Obtenemos el ID del cuerpo de la petición (POST)
    $id_archivo_producto = $request->getParsedBody()['id_archivo_producto'];

    $response = array();
    $db = new DbHandler();
    
    // Llamamos a la nueva función de borrado lógico
    $resultado = $db->deleteArchivoProducto($id_archivo_producto);
    ...
    if ($resultado == RECORD_CREATED_SUCCESSFULLY) {
        ...
        $response["error"] = true;
        $response["msg"] = "¡Ocurrió un error al intentar eliminar el archivo!";
    }

    echo json_encode($response);
});

$app->post('/fulmuv/cuenta_cliente/delete', function ($request, $response) {
    // Obtenemos el ID del cuerpo de la petición (POST)
    ...
    // Llamamos a la nueva función de borrado lógico
    $resultado = $db->eliminarCuentaCliente($id_cliente);

    if ($resultado == RECORD_CREATED_SUCCESSFULLY) {
        $response["error"] = false;
        $response["msg"] = "Cuenta desactivada correctamente.";
    } else {
        $response["error"] = true;
        $response["msg"] = "¡Ocurrió un error al intentar eliminar el cliente!";
    }
